      ...
      <div class="user-menu-container">
        ...
        <div v-if="showUserMenu" class="user-menu">
          <template v-if="!authStore.isLoggedIn">
            ...
            <router-link to="/selectTypeAccount" class="user-menu-item">{{ t('userMenu.register') }}</router-link>
          </template>
...
import { useSubastasStore } from '../store/subastas'; // 1. Importar el store de subastas
...
const subastasStore = useSubastasStore(); // 2. Inicializar el store de subastas
...
// 3. Lógica de búsqueda actualizada para conectar con el store
const updateSearchQuery = (event) => {
  // Llama a la acción del store para actualizar el término de búsqueda en tiempo real
